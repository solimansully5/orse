...
class GetAllCategories{
  ...
  getallcategories({
    ...
    var request = Request('GET', Uri.parse('https://orse.herokuapp.com/api/categories'));
    ...
    if (response.statusCode == 200) {
     ...
     Categories categories = Categories.fromJson(categoriesJson);
