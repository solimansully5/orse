...
class GetAllLesson{
  ...
  getalllesson({
    String id,
    Function(lessonwithvideo) onSuccess,
    Function() onFail
  })async{
    var headers = {
    ...
    var request = Request('GET', Uri.parse('https://orse.herokuapp.com/api/lessons/'+id));
    ...
    if (response.statusCode == 200) {
      print(response.body);
      Map<String, dynamic> lessonsJson = jsonDecode(response.body);
      print(lessonsJson);
      lessonwithvideo less = lessonwithvideo.fromJson(lessonsJson);
      onSuccess(less);
    }
    else {
